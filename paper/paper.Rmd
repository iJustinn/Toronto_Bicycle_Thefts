...
<div class="main-body">
  ...
  <p>But rather than just telling you the facts, let’s try something different—how about hearing it straight from the perspective of a <strong>bike?</strong></p>
</div>
...
<div class="main-body">
  ...
  <p>We’ve looked at over ten years of data from the <a href="https://data.torontopolice.on.ca/datasets/TorontoPS::bicycle-thefts-open-data/about" target="_blank" style="color: #FFC107; text-decoration: underline;">Toronto Police Service</a> (Toronto Police Service, 2024c) to answer some big questions: When are bikes like me at the most risk? What makes us targets? And which parts of Toronto should we avoid? Over this time, <strong style="color: #FFC107;">32,489</strong> bikes have been reported stolen in Toronto, but only <strong style="color: #FFC107;">422</strong> were ever recovered. With these insights, we hope to give cyclists like you the knowledge to protect us better, while helping groups like Cycle Toronto and local officials focus on areas that need the most attention. Together, we’ll uncover theft trends, identify high-risk locations, and share practical tips to keep your bike safe and secure.</p>
</div>
...
<div class="main-body">
  <p>The map below gave us another step back, which is a chance for us to see how each areas compare when it comes to bike theft. It’s a colorful scene, with bubbles of different sizes and shades showing how many of us have been stolen in each area. The larger the bubble, the more incidents it represents. And right in the heart of the city is a massive <strong style="color: #FFC107;">yellow</strong> circle, covering downtown Toronto. It’s like a giant warning sign, confirming what we already know: the core of the city is the most dangerous place for bikes like me.</p>
  
  <p>Further out, the bubbles shrink, and the map starts to feel calmer. These smaller circles mark neighborhoods where thefts are less common, offering a glimpse of what safety might look like. It’s a sharp divide—some areas are hotspots, buzzing with theft activity, while others stay quiet and safer. For bikes like me, maps like this are a lifeline, helping us and our riders navigate Toronto’s streets with a better sense of where to stay extra cautious.</p>
</div>
...
<div class="main-body">
  ...
  <p>Altogether, these visualizations offer a complete story of Toronto’s bike theft problem. They show the when, where, and why of theft, giving insights that can inspire action. Moving forward, Toronto can do more to protect bikes like me by creating more secure parking, working closely with registration platforms like Project 529, and expanding targeted programs like Project Sentry in high-risk areas. Maybe future studies will take this analysis nationwide, shedding light on bike theft patterns across Canada. With all these efforts combined, cyclists, city officials, and advocacy groups can work together to make Toronto a <strong style="color: #FFC107;">safer</strong> place for bikes like me to ride, rest, and thrive.</p>
</div>
